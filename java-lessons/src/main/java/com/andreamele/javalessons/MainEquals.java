...
public class MainEquals {
    public static void main(String[] args) {
        ...
        Quadrilatero q1 = new QuadratoV2(15);
        //q1.setLato(20);
       //System.out.println("il lato del quadrato risettato è " +q1.getLato());
        ...
        Quadrilatero r2 = new RettangoloV2(15,20);
        ...
        System.out.println("r1 è uguale a r2 ? " + r1.equals(r2));
